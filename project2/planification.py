...
class planification:
    def __init__(self, root, pro_name, site_name, bsite1):
        ...
        self.bplan = Button(frame_canvas2, text="planification", width=self.wbutton, height=self.hbuttonm,bg="#38B449")
    ...
    def b(self):
        bplani = Button(self.frame22, text='planification de controle réglementaire', width=self.wbuttoni, height=self.hbuttoni)
        bplani.grid(row=0, column=0)
        bobj = Button(self.frame22, text='objectifs et planification', width=self.wbuttoni, height=self.hbuttoni)
        bobj.grid(row=0, column=1)
        bsitu = Button(self.frame22, text="situation d'urgence et accident ", width=self.wbuttoni, height=self.hbuttoni)
        bsitu.grid(row=0, column=2)
        biden = Button(self.frame22, text='identification des danger SST ', width=self.wbuttoni, height=self.hbuttoni)
        biden.grid(row=0, column=3)
        basp = Button(self.frame22, text='aspects environnementaux ', width=self.wbuttoni, height=self.hbuttoni)
        basp.grid(row=0, column=4)
        bimp= Button(self.frame22, text="impact environnementaux", width=self.wbuttoni, height=self.hbuttoni)
        bimp.grid(row=0, column=5)
        bdesc = Button(self.frame22, text='description de danger SDA', width=self.wbuttoni, height=self.hbuttoni)
        bdesc.grid(row=0, column=6)
        bdia = Button(self.frame22, text="diagrame de flux", width=self.wbuttoni, height=self.hbuttoni)
        bdia.grid(row=1, column=0)
