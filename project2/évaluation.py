...
class évaluation:
    def __init__(self, root, pro_name, site_name, bsite1):
        ...
        self.béval = Button(frame_canvas2, text="évaluation des perfermancen", width=self.wbutton, height=self.hbuttonm,bg='green')
    ...
    def b(self):
        bsati= Button(self.frame22, text='satisfaction client', width=self.wbuttoni, height=self.hbuttoni)
        bsati.grid(row=0, column=0)
        baudit = Button(self.frame22, text='audit', width=self.wbuttoni, height=self.hbuttoni)
        baudit.grid(row=0, column=1)
        brpro= Button(self.frame22, text="revue de processus", width=self.wbuttoni, height=self.hbuttoni)
        brpro.grid(row=0, column=2)
        bindi = Button(self.frame22, text='indicateurs ', width=self.wbuttoni, height=self.hbuttoni)
        bindi.grid(row=0, column=3)
        bévalpoli = Button(self.frame22, text='évaluation politique qualité', width=self.wbuttoni, height=self.hbuttoni)
        bévalpoli.grid(row=0, column=4)
        bévalro= Button(self.frame22, text="évaluation des risque \net des opportunitées", width=self.wbuttoni, height=self.hbuttoni)
        bévalro.grid(row=0, column=5)
        bévalrsst= Button(self.frame22, text='évaluation des risque SST', width=self.wbuttoni, height=self.hbuttoni)
        bévalrsst.grid(row=0, column=6)
        bévalrenv= Button(self.frame22, text="évaluation des impacts et des\nspectst environnementaux ", width=self.wbuttoni, height=self.hbuttoni)
        bévalrenv.grid(row=1, column=0)
        bsda = Button(self.frame22, text='analyse des danger SDA', width=self.wbuttoni, height=self.hbuttoni)
        bsda.grid(row=1, column=1)
        bévalurg = Button(self.frame22, text="évaluation des situation d'urgence ", width=self.wbuttoni, height=self.hbuttoni)
        bévalurg.grid(row=1, column=2)
        bévalfor= Button(self.frame22, text="évaluation des formations", width=self.wbuttoni, height=self.hbuttoni)
        bévalfor.grid(row=1, column=3)
        brdir = Button(self.frame22, text="revue de direction", width=self.wbuttoni, height=self.hbuttoni)
        brdir.grid(row=1, column=4)
