...
class amélioration:
    def __init__(self, root, pro_name, site_name, bsite1):
        ...
        self.bamé = Button(frame_canvas2, text="amélioration", width=self.wbutton, height=self.hbuttonm,bg='green')
    ...
    def b(self):
        bnon= Button(self.frame22, text='non-conformité', width=self.wbuttoni, height=self.hbuttoni)
        bnon.grid(row=0, column=0)
        bact = Button(self.frame22, text='action', width=self.wbuttoni, height=self.hbuttoni)
        bact.grid(row=0, column=1)
        bprp= Button(self.frame22, text="PRPop", width=self.wbuttoni, height=self.hbuttoni)
        bprp.grid(row=0, column=2)
        bhccp = Button(self.frame22, text='plan HCCP ', width=self.wbuttoni, height=self.hbuttoni)
        bhccp.grid(row=0, column=3)
