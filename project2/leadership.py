...
class leadership:
    def __init__(self, root, pro_name, site_name, bsite1):
        ...
        self.bleader = Button(frame_canvas2, text="leadership", width=self.wbutton, height=self.hbuttonm,bg='#38B449')
    ...
    def b(self):
        bpoli = Button(self.frame22, text='politique QSE', width=self.wbuttoni, height=self.hbuttoni)
        bpoli.grid(row=0, column=0)
        bres = Button(self.frame22, text='responsabilités et autorités ', width=self.wbuttoni, height=self.hbuttoni)
        bres.grid(row=0, column=1)
