...
# MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
            ...
            self.béval = Button(frame_canvas2, text="évaluation des perfermancen", width=self.wbutton,
                                height=self.hbuttonm)
...
#ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        def go_contexte():
            ...
            go = organisme.organisme(self.root, self.pro_name, self.site_name, self.bsite1)
            go.all_items()
            go.b()
