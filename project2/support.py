...
class support:
    def __init__(self, root, pro_name, site_name, bsite1):
        ...
        self.bsupp = Button(frame_canvas2, text="support", width=self.wbutton, height=self.hbuttonm,bg='green')
    ...
    def b(self):
        bdoc = Button(self.frame22, text='documents', width=self.wbuttoni, height=self.hbuttoni)
        bdoc.grid(row=0, column=0)
        benr = Button(self.frame22, text='enregistrements', width=self.wbuttoni, height=self.hbuttoni)
        benr.grid(row=0, column=1)
        bcom = Button(self.frame22, text="communication ", width=self.wbuttoni, height=self.hbuttoni)
        bcom.grid(row=0, column=2)
        bres = Button(self.frame22, text='ressources humains ', width=self.wbuttoni, height=self.hbuttoni)
        bres.grid(row=0, column=3)
        bper = Button(self.frame22, text='personnel desactivées', width=self.wbuttoni, height=self.hbuttoni)
        bper.grid(row=0, column=4)
        bjour= Button(self.frame22, text="journal d'intégration", width=self.wbuttoni, height=self.hbuttoni)
        bjour.grid(row=0, column=5)
        bcomp= Button(self.frame22, text='compétence et polyvalence', width=self.wbuttoni, height=self.hbuttoni)
        bcomp.grid(row=0, column=6)
        bbes = Button(self.frame22, text="besoin en connaissance", width=self.wbuttoni, height=self.hbuttoni)
        bbes.grid(row=1, column=0)
        bfor = Button(self.frame22, text='formation', width=self.wbuttoni, height=self.hbuttoni)
        bfor.grid(row=1, column=1)
        binfra = Button(self.frame22, text="infrastructures ", width=self.wbuttoni, height=self.hbuttoni)
        binfra.grid(row=1, column=2)
        binj= Button(self.frame22, text="plan d'injustement des compétences ", width=self.wbuttoni, height=self.hbuttoni)
        binj.grid(row=1, column=3)
